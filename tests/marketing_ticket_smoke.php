...
assertSameValue(true, strpos($helpersSource, 'asignado_a = ?') !== false, 'ticket updates always persist assignment');
assertSameValue(true, strpos($helpersSource, 'fecha_entrega_estimada = ?') !== false, 'ticket updates always persist estimated delivery date');
...
assertSameValue(false, strpos($ticketUpdateSource, 'cdaMarketingTicketUpdateColumnsReady') !== false, 'ticket update does not block on SHOW COLUMNS permissions');
