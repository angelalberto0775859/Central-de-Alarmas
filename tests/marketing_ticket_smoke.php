...
assertSameValue(true, function_exists('cdaMarketingFetchAssignableUsers'), 'admins managers and workers can be fetched for assignment');
...
assertSameValue(true, strpos($panelHtml, 'cdaMarketingFetchAssignableUsers') !== false, 'panel assigns tickets to admins managers and workers');
assertSameValue(true, strpos($controlHtml, 'cdaMarketingFetchAssignableUsers') !== false, 'board assigns tickets to admins managers and workers');
